...
- **[daily-bug-triage.md](daily-bug-triage.md)**: triage New bugs (excludes embargoed issuetype/security level); merged fix PRs on In Progress bugs → **Review** (Phase 0). Auto-fix stays **off** unless `ENABLE_AUTO_FIX` is set.
